...
<head>
  ...
  ================================================== -->
	...
	<!-- Magnific popup css -->
	<link rel="stylesheet" href="theme/plugins/magnific-popup/dist/magnific-popup.css">
	<!-- Slick Carousel -->
...
==================================== -->
	...
	<section class="hero-area overlay" style="background-image: url('theme/images/banner/car.jpg');">
		<!-- <video autoplay muted loop class="hero-video">
		<source src="images/banner/hero-video.mp4" type="video/mp4">
	</video> -->
		<div class="block">
			<div class="video-button mb-10">
	...
	<section class="section about-2 padding-0 bg-dark" id="about">
		<div class="container-fluid p-0">
			<div class="row no-gutters align-items-center">
				<div class="col-lg-6">
					<img class="img-fluid" src="theme/images/about/about-business-man.jpg" alt="">
				</div>
				<div class="col-lg-6">
			...
			<div class="row">
				<div class="col-md-6">
					...
					<p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis magni explicabo cum aperiam recusandae
						...
						tempora!</p>
					<img class="img-fluid" src="theme/images/about/company-growth.png" alt="">
				</div>
				<div class="col-md-6 mt-4 mt-md-0">
					<ul class="skill-bar">
						...
						<li>
							...
							<div class="progress">
								<div class="progress-bar" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="width:94%">
								</div>
							</div>
						</li>
					</ul>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="portfolio-filter">
						...
						<button type="button" data-filter="photography">CAR CONSULTATION</button>
						<button type="button" data-filter="design">CAR BUY & SELL</button>
						<button type="button" data-filter="development">GENRAL INSURANCE</button>
					</div>
				</div>
			</div>
			<div class="row mx-auto filtr-container">
				<div class="filtr-item col-lg-4 col-md-6" data-category="development">
					<div class="portfolio-block">
						<img src="theme/images/portfolio/portfolio-1.jpg" alt="">
						<div class="caption">
							<a class="search-icon image-popup" data-effect="mfp-with-zoom" href="theme/images/portfolio/portfolio-1.jpg" data-lightbox="image-1">
				...
				<div class="filtr-item col-lg-4 col-md-6" data-category="design">
					<div class="portfolio-block">
						<img src="theme/images/portfolio/portfolio-2.jpg" alt="">
						<div class="caption">
							<a class="search-icon image-popup" data-effect="mfp-with-zoom" href="theme/images/portfolio/portfolio-2.jpg" data-lightbox="image-1">
								<i class="tf-ion-android-search"></i>
							</a>
				...
				<div class="filtr-item col-lg-4 col-md-6" data-category="design, development">
					<div class="portfolio-block">
						<img src="theme/images/portfolio/portfolio-3.jpg" alt="">
						<div class="caption">
							<a class="search-icon image-popup" data-effect="mfp-with-zoom" href="theme/images/portfolio/portfolio-3.jpg" data-lightbox="image-1">
								<i class="tf-ion-android-search"></i>
							</a>
				...
				<div class="filtr-item col-lg-4 col-md-6" data-category="photography, development">
					<div class="portfolio-block">
						<img src="theme/images/portfolio/portfolio-4.jpg" alt="">
						<div class="caption">
							<a class="search-icon image-popup" data-effect="mfp-with-zoom" href="theme/images/portfolio/portfolio-4.jpg" data-lightbox="image-1">
								<i class="tf-ion-android-search"></i>
							</a>
				...
				<div class="filtr-item col-lg-4 col-md-6" data-category="design">
					<div class="portfolio-block">
						<img src="theme/images/portfolio/portfolio-5.jpg" alt="">
						<div class="caption">
							<a class="search-icon image-popup" data-effect="mfp-with-zoom" href="theme/images/portfolio/portfolio-5.jpg" data-lightbox="image-1">
								<i class="tf-ion-android-search"></i>
							</a>
				...
				<div class="filtr-item col-lg-4 col-md-6" data-category="photography">
					<div class="portfolio-block">
						<img src="theme/images/portfolio/portfolio-6.jpg" alt="">
						<div class="caption">
							<a class="search-icon image-popup" data-effect="mfp-with-zoom" href="theme/images/portfolio/portfolio-6.jpg" data-lightbox="image-1">
								<i class="tf-ion-android-search"></i>
							</a>
							<h4><a href="">Tag Design</a></h4>
							<p class="mb-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam, nemo!</p>
				...
				<div class="filtr-item col-lg-4 col-md-6" data-category="design">
					<div class="portfolio-block">
						<img src="theme/images/portfolio/portfolio-7.jpg" alt="">
						<div class="caption">
							<a class="search-icon image-popup" data-effect="mfp-with-zoom" href="theme/images/portfolio/portfolio-7.jpg" data-lightbox="image-1">
								<i class="tf-ion-android-search"></i>
							</a>
				...
				<div class="filtr-item col-lg-4 col-md-6" data-category="design">
					<div class="portfolio-block">
						<img src="theme/images/portfolio/portfolio-8.jpg" alt="">
						<div class="caption">
							<a class="search-icon image-popup" data-effect="mfp-with-zoom" href="theme/images/portfolio/portfolio-8.jpg" data-lightbox="image-1">
								<i class="tf-ion-android-search"></i>
							</a>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6 wow fadeIn" data-wow-duration="500ms">
					<div class="team-member">
						<div class="member-photo">
							<!-- member photo -->
							<img class="img-fluid" src="theme/images/team/team-1.jpg" alt="Meghna">
							<!-- /member photo -->
				...
				<div class="col-lg-3 col-md-6 wow fadeIn" data-wow-duration="500ms" data-wow-delay="200ms">
					<div class="team-member">
						<div class="member-photo">
							<!-- member photo -->
							<img class="img-fluid" src="theme/images/team/team-2.jpg" alt="Meghna">
							<!-- /member photo -->
				...
				<div class="col-lg-3 col-md-6 wow fadeIn" data-wow-duration="500ms" data-wow-delay="400ms">
					<div class="team-member">
						<div class="member-photo">
							<!-- member photo -->
							<img class="img-fluid" src="theme/images/team/team-3.jpg" alt="Meghna">
							<!-- /member photo -->
				...
				<div class="col-lg-3 col-md-6 wow fadeIn" data-wow-duration="500ms" data-wow-delay="600ms">
					<div class="team-member">
						<div class="member-photo">
							<!-- member photo -->
							<img class="img-fluid" src="theme/images/team/team-4.jpg" alt="Meghna">
							<!-- /member photo -->
	...
	<section id="pricing" class="pricing section section-bg">
		<div class="container">
			<div class="row">
				...
				<!-- single pricing table -->
				<div class="col-lg-3 col-md-6 text-center wow fadeInUp" data-wow-duration="500ms" data-wow-delay="400ms">
					<div class="price-item">
				...
				<!-- single pricing table -->
				<div class="col-lg-3 col-md-6 text-center wow fadeInUp" data-wow-duration="500ms" data-wow-delay="600ms">
					<div class="price-item">
				...
				<!-- single pricing table -->
				<div class="col-lg-3 col-md-6 text-center wow fadeInUp" data-wow-duration="500ms" data-wow-delay="750ms">
					<div class="price-item">
					...
					<div id="testimonials" class="wow fadeInUp" data-wow-duration="500ms" data-wow-delay="100ms">
						...
						<div class="item text-center">
							...
							<div class="client-thumb">
								<img src="theme/images/team/client-1.jpg" class="img-fluid" alt="Meghna">
							</div>
							<!-- /client photo -->
						...
						<div class="item text-center">
							...
							<!-- client photo -->
							<div class="client-thumb">
								<img src="theme/images/team/client-2.jpg" class="img-fluid" alt="Meghna">
							</div>
							<!-- /client photo -->
		...
		<div class="container">
			<div class="row">
				...
				<article class="col-lg-4 col-md-6 wow fadeInUp" data-wow-duration="500ms">
					<div class="post-block">
						<div class="media-wrapper">
							<img src="theme/images/blog/blog-post-1.jpg" alt="amazing caves coverimage" class="img-fluid">
						</div>
						<div class="content">
							<h3><a href="theme/blog.html">Simple Image Post</a></h3>
				...
				<article class="col-lg-4 col-md-6 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="200ms">
					<div class="post-block">
						<div id="gallery-post" class="media-wrapper">
							<div class="item">
								<img src="theme/images/blog/blog-post-1.jpg" alt="blog post" class="img-fluid">
							</div>
							<div class="item">
								<img src="theme/images/blog/blog-post-3.jpg" alt="blog post" class="img-fluid">
							</div>
							<div class="item">
								<img src="theme/images/blog/blog-post-2.jpg" alt="blog post | Meghna" class="img-fluid">
							</div>
						</div>
				...
				<article class="col-lg-4 col-md-6 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="400ms">
					<div class="post-block">
						<div class="media-wrapper">
							<img src="theme/images/blog/blog-post-6.jpg" alt="amazing caves coverimage" class="img-fluid">
						</div>
				...
				<div class="col-12">
					<div class="all-post text-center">
						<a class="btn btn-main" href="theme/blog.html">View All Post</a>
					</div>
				</div>
			</div> <!-- end row -->
		</div> <!-- end container -->
...
========================================== -->
	...
	<!-- Slick Carousel -->
	<script src="theme/plugins/slick-carousel/slick.min.js"></script>
	<!-- Portfolio Filtering -->
	<script src="theme/plugins/filterzr/jquery.filterizr.min.js"></script>
	<!-- Magnific popup -->
	<script src="theme/plugins/magnific-popup/dist/jquery.magnific-popup.min.js"></script>
	<!-- Google Map API -->
	<script src="theme/https://maps.googleapis.com/maps/api/js?key=AIzaSyAgeuuDfRlweIs7D6uo4wdIHVvJ0LonQ6g"></script>
	<script src="theme/plugins/google-map/gmap.js"></script>
	<!-- wow.min Script -->
	<script src="theme/plugins/wow/wow.min.js"></script>
	<!-- Custom js -->
